...
inputs = {
  ...
  secrets = {
    DB_HOST     = "arn:aws:ssm:us-east-1:061565848348:parameter/staging/interactive-translator/learner_db_host"
    DB_PASSWORD = "arn:aws:ssm:us-east-1:061565848348:parameter/staging/interactive-translator/learner_db_pass"
  }
