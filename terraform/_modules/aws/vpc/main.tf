...
resource "aws_default_route_table" "default" {
  ...
  tags = merge(
    { "Name" = "rtb-${coalesce(var.default_route_table_name, var.name)}" },
    var.tags,
...
resource "aws_route_table" "private" {
  ...
  tags = merge(
    {
      "Name" = var.single_nat_gateway ? "rtb-${var.name}-${var.private_subnet_suffix}" : format(
        "rtb-${var.name}-${var.private_subnet_suffix}-az%s",
        count.index + 1,
      )
    },
    var.tags,
...
resource "aws_route_table" "database" {
  ...
  tags = merge(
    {
      "Name" = var.single_nat_gateway || var.create_database_internet_gateway_route ? "rtb-${var.name}-${var.database_subnet_suffix}" : format(
        "rtb-${var.name}-${var.database_subnet_suffix}-az%s",
        count.index + 1,
      )
    },
    var.tags,
...
resource "aws_route_table" "redshift" {
  ...
  tags = merge(
    { "Name" = "rtb-${var.name}-${var.redshift_subnet_suffix}" },
    var.tags,
...
resource "aws_route_table" "elasticache" {
  ...
  tags = merge(
    { "Name" = "rtb-${var.name}-${var.elasticache_subnet_suffix}" },
    var.tags,
...
resource "aws_route_table" "intra" {
  ...
  tags = merge(
    { "Name" = "rtb-${var.name}-${var.intra_subnet_suffix}" },
    var.tags,
...
resource "aws_subnet" "public" {
  ...
  tags = merge(
    {
      "Name" = format(
        "net-${var.name}-${var.public_subnet_suffix}-az%s",
        count.index + 1,
      )
    },
    var.tags,
...
resource "aws_subnet" "private" {
  ...
  tags = merge(
    {
      "Name" = format(
        "net-${var.name}-${var.private_subnet_suffix}-az%s",
        count.index + 1,
      )
    },
    var.tags,
...
resource "aws_subnet" "database" {
  ...
  tags = merge(
    {
      "Name" = format(
        "net-${var.name}-${var.database_subnet_suffix}-az%s",
        count.index + 1,
      )
    },
    var.tags,
...
resource "aws_db_subnet_group" "database" {
  ...
  name        = "netgr-${lower(coalesce(var.database_subnet_group_name, var.name))}"
...
resource "aws_subnet" "redshift" {
  ...
  tags = merge(
    {
      "Name" = format(
        "net-${var.name}-${var.redshift_subnet_suffix}-az%s",
        count.index + 1,
      )
    },
    var.tags,
...
resource "aws_redshift_subnet_group" "redshift" {
  ...
  tags = merge(
    { "Name" = "netgr-${coalesce(var.redshift_subnet_group_name, var.name)}" },
    var.tags,
...
resource "aws_subnet" "elasticache" {
  ...
  tags = merge(
    {
      "Name" = format(
        "net-${var.name}-${var.elasticache_subnet_suffix}-az%s",
        count.index + 1,
      )
    },
    var.tags,
...
resource "aws_elasticache_subnet_group" "elasticache" {
  ...
  name        = "netgr-${coalesce(var.elasticache_subnet_group_name, var.name)}"
...
resource "aws_subnet" "intra" {
  ...
  tags = merge(
    {
      "Name" = format(
        "net-${var.name}-${var.intra_subnet_suffix}-az%s",
        count.index + 1,
      )
    },
    var.tags,
...
resource "aws_eip" "nat" {
  ...
  tags = merge(
    {
      "Name" = var.single_nat_gateway ? "eip-${var.name}-nat" : format(
        "eip-${var.name}-nat-az%s",
        count.index + 1,
      )
    },
    var.tags,
...
resource "aws_nat_gateway" "this" {
  ...
  tags = merge(
    {
      "Name" = var.single_nat_gateway ? "nat-${var.name}" : format(
        "nat-${var.name}-az%s",
        count.index + 1,
      )
    },
